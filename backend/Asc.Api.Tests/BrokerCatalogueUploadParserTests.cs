...
public class BrokerCatalogueUploadParserTests
{
    ...
    public void ParseAeb_ReadsRealSample36Row()
    {
        ...
        var result = BrokerCatalogueUploadParser.ParseAeb(rows, 36);
    ...
    [Fact]
    public void ParseAeb_CountsSkippedRows_ForShortAndInvalidRows()
    {
        var rows = Blank(
            Row("EB", "2026", "36A", "1", "MF0034"), // too few columns
            Row("EB", "2026", "36A", "2", "", "STRATHSPEY", "0254R", "BOP", "20", "50", "1000", "1000"), // blank MF code
            Row("EB", "2026", "36A", "3", "MF0035", "GLENUGIE", "0255R", "BOP", "20", "50", "1000", "1000"));
        var result = BrokerCatalogueUploadParser.ParseAeb(rows, 36);
    ...
    public void ParseBc_ReadsRealSample36Row()
    {
        ...
        var lots = BrokerCatalogueUploadParser.ParseBc(rows, 36).Lots;
    ...
    public void ParseJk_ReadsRealSample36Row_WithNoBrokerColumnInFile()
    {
        ...
        var lots = BrokerCatalogueUploadParser.ParseJk(rows, 36).Lots;
    ...
    public void ParseLcbl_SkipsSectionDividerRows()
    {
        ...
        var result = BrokerCatalogueUploadParser.ParseLcbl(rows, 36);
        var lots = result.Lots;

        Assert.Equal(2, lots.Count); // the "EX-ESTATE" divider row must not become a lot
        Assert.Equal(0, result.SkippedRows); // divider rows are not counted as skips
    ...
    public void ParseMb_ReadsRealSample36Row_AndMatchesLcblFactoryAfterNormalization()
    {
        ...
        var lots = BrokerCatalogueUploadParser.ParseMb(rows, 36).Lots;
    ...
    public void ParseFw_ReadsRealSample36Row()
    {
        ...
        var lots = BrokerCatalogueUploadParser.ParseFw(rows, 36).Lots;
    ...
    public void ParseAsc_ReadsRealSample36Row_ViaHeaderRow()
    {
        ...
        var lots = BrokerCatalogueUploadParser.ParseAsc(new CatalogueImportService(), rows, 36).Lots;
    ...
    public void ParseCtb_ReadsRealSample36Row_ReprintDetectedFromWeightMismatch()
    {
        ...
        var lots = BrokerCatalogueUploadParser.ParseCtb(rows, 36).Lots;
