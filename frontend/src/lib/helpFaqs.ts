/** Shared FAQ content — rendered on both /help (unchanged, still directly reachable) and
 *  the Knowledge Base hub's own Help section (folded in per the ASIS overhaul). One source
