...
/** ASC's own pre-auction valuation vs. the actual settled auction price, for the active
 *  catalogue — originally its own top-level "Market Intelligence" page, now the "Market
 *  Accuracy" tab inside Analysis (Phase 9 IA consolidation, same fold-in pattern the
 *  "Valuations" tab already used). Import/compare behavior is unchanged; only the page
 *  chrome (its own PageHeader) was left to the caller so it fits inside a tabbed shell. */
export default function MarketAccuracyAnalysis() {
